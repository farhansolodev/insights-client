...
const runProject = require('./project_runner')
...
if (noArgs || wantsHelp) (() => {console.log(`
...
isContributor && setupDevEnv(runCmd, __rootdir)
wantsToRun && runProject(runCmd, __rootdir)
